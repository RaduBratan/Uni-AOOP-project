...
public class DeveloperSingleton {
    ...
    public static DeveloperSingleton getInstance() {
        if (instance == null)
            instance = new DeveloperSingleton();
        return instance;
    }
    ...
    */
    ...
    public void readFromCSV() {
        try {
            var columns = DeveloperSingleton.getCSVColumns("data/developers.csv");
